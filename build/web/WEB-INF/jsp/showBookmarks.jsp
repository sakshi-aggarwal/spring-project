<%-- 
    Document   : showBookmarks
    Created on : 18 Jan, 2017, 8:20:05 PM
...
<div class="img">
     ...
     <a href="<c:url value="/authorisedItems.htm">
            <c:param name='pr_no' value="${disc.getPr_no()}"/>
                        ...
                        <f:form  action="removeBookmark.htm?pr_no=${disc.getPr_no()}"  style="color:blue">
       <input type="submit" class="desc" value="Remove From Bookmarks" />
       </f:form>
</div>
                     </c:forEach>
        </div>
