<%-- 
    Document   : authorisedProduct
    Created on : 17 Jan, 2017, 9:12:42 PM
...
<h4>Refine By</h4>
        ...
        <p>Brand: <br /><input type="text" name="t1"/><br /><br /></p>
        <p>Colour: <br /><input type="text" name="t2"/><br /><br /></p>
        <p>Price:  <br /><input type="text" name="t3"/><br /><br /></p>
        <p>Size:  <br /><input type="text" name="t4"/><br /><br /></p>

    </div>


    <div class="col-8" id="a">
