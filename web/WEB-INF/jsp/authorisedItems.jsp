<%-- 
    Document   : AuthorisedItems
    Created on : 17 Jan, 2017, 10:52:28 PM
...
<div class="row">
    ...
    <div class="col-6" style="margin-top:5%;">
        ...
        <f:form action="bookmark.htm?user=${sessionScope.user}&pr_no=${specsv.getPr_no()}" method="POST">
        <input type="submit" class="button" value="BOOKMARK THIS ITEM" />
        </f:form>
        <f:form action="addToCart.htm?user=${sessionScope.user}&pr_no=${specsv.getPr_no()}" method="POST">
